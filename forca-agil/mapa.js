  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Eventos — a fila guarda um registro por PESSOA e por ORIGEM (turma de onde saiu, ou "lista" para quem entrou pelo card do site); quem passou por duas turmas aparece duas vezes, e sair da mesma turma de novo mantém um registro só, com a data mais antiga', p: ['admin'] },
        { label: 'Aba Eventos — tirar alguém da fila (Remover da lista, Mover para turma, ou o botão do próprio site) vale para TODAS as origens dela: quem foi inscrita ou desistiu não espera mais por origem nenhuma', p: ['admin'] },
        ...
        { label: 'Aba Eventos — bloco de conferência acima da Lista de Espera: mostra por que a soma dos "Foram para a espera" das turmas não bate com o tamanho da fila (uma entrada por PESSOA contra uma saída por TURMA) e separa o que é diferença esperada do que é registro engolido pela sobrescrita', p: ['admin'] },
        ...
        { label: 'Aba Eventos — Lista de Espera: coluna "Origem" mostra de qual turma a pessoa foi migrada e o motivo; quem entrou direto pelo card do site aparece como "Entrou pela lista", com traço na data de remoção', p: ['admin'] },
