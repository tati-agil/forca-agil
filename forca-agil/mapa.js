    ...
    const ARCH = [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'forca-agil/avaliacao.js',     desc: 'Avaliação da Oficina — formulário em accordion com 13 seções (7 obrigatórias de 0–10, 6 opcionais). Visível apenas para admin e inscritos confirmados em turma com avaliação habilitada pelo admin. Rascunho automático por turma, envio único, progresso por seção. Identificação opcional: checkbox anônimo por padrão; se marcado, grava nomeExibido e identificado:true em avaliacoes/<turmaKey>/<emailKey>. API: window.faAvaliacao' },
