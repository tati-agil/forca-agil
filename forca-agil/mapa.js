  ...
  const PAGES = [
    ...
    { label: 'TURMAS', color: '#f5c542',
      features: [
        ...
        { label: 'Turma finalizada para não inscrito (visitante ou logado sem essa turma): botão de interesse desaparece, card exibe "Inscrições encerradas" (sem ação disponível, sem abrir modal de login)', p: ['visitante','logado'] },
