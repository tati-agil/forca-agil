  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Cadastrados — criar conta diretamente para colaboradora (nome + e-mail + área, lista fechada com as 20 gerências + senha do admin; senha padrão 12345678; sem verificação de e-mail — não precisa ser uma caixa real, adminApproved pula a checagem)', p: ['admin'] },
