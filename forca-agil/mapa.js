  ...
  const PAGES = [
    ...
    { label: 'TURMAS', color: '#f5c542',
      features: [
        ...
        { label: 'Cada botão de interesse só recebe um clique-listener — revisitar a página Turmas (ou logar/deslogar nela) não duplica o comportamento do botão', p: ['visitante','logado','admin'] },
