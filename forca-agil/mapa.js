    ...
    const ARCH = [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'forca-agil/pedidos.js',       desc: 'Formulário público "Faça um pedido" (seção Ajuda) e painel admin Aba Pedidos. Público: seleção de tipo (tema/curso/material/dúvida/outros) + textarea + envio autenticado para Firebase pedidos/. Admin: lê node pedidos/, renderiza com chips de filtro por tipo e contagem, ordem mais recente primeiro. Cada item tem link mailto: (Responder por e-mail — abre o cliente de e-mail do admin, não envia pelo site) e fluxo "Marcar como respondido" com seletor de qual admin respondeu (carrega lista de fa-admins + super-admins via fa-users), gravando respondido/respondidoEm/respondidoPor em pedidos/<key>. Calcula e exibe prazo em dias úteis (função diasUteisEntre — sábado/domingo contam como segunda-feira 8h) tanto para pedidos em aberto quanto respondidos.' },
