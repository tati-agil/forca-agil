  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Eventos — selo "👥 PÚBLICO RESTRITO · N" no cabeçalho da turma fechada, e aviso com nomes quando alguém está na turma sem estar na lista (marcar a caixa numa turma que já tem gente não remove ninguém)', p: ['admin'] },
