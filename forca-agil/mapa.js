  ...
  const PAGES = [
    { label: 'ADMIN', color: '#ff5252',
      features: [
        ...
        { label: 'Aba Turmas — encerrar turma manualmente (marca como "Realizada" antes do prazo automático — disponível via menu ⋯ quando interesse já foi encerrado)', p: ['admin'] },
