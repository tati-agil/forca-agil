  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Cadastrados — a fila guarda um registro por PESSOA e por ORIGEM (turma de onde saiu, ou "lista" para quem entrou pelo card do site); quem passou por duas turmas aparece duas vezes, e sair da mesma turma de novo mantém um registro só, com a data mais antiga', p: ['admin'] },
        { label: 'Aba Cadastrados — tirar alguém da fila (Remover da lista, Mover para turma, ou o botão do próprio site) vale para TODAS as origens dela: quem foi inscrita ou desistiu não espera mais por origem nenhuma', p: ['admin'] },
        { label: 'Aba Cadastrados — seção recolhida "Saíram da fila" abaixo da lista: quem já esteve na fila e não está mais, com "🗑 excluir registro" por linha (apaga de vez, para teste e duplicado; só em quem já saiu, e não toca no cadastro nem nas turmas), origem, quando saiu, destino e motivo, e a autoria quando ela está gravada — nome do admin, ou "pela própria pessoa" quando a saída foi pelo botão do card do site. Sair da fila nunca apaga o registro, mas até então não havia como enxergá-lo', p: ['admin'] },
