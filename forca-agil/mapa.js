  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Eventos — botão "→ Espera" move o participante da turma para a lista de espera, exigindo escolher o motivo (Turma sem vagas / Turma já encerrada / Remanejada para próxima turma / A pedido da pessoa / Evento encerrado / Outro); a data original de interesse é preservada', p: ['admin'] },
    ...
    { label: 'MINHA ÁREA', color: '#26a69a',
      features: [
        ...
        { label: 'Ver as turmas em que está confirmada, com selo "Em andamento" ou "Concluída", nome do evento, carga horária e datas dos encontros', p: ['inscrito','admin'] },
