  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Eventos — motivos de saída: A pedido da própria pessoa · Vai fazer em outra turma (escolhe QUAL) · Turma sem vagas · A data não serviu · Já participou · Não respondeu · Registro duplicado · Evento encerrado · Outro', p: ['admin'] },
        { label: 'Aba Eventos — a ida para a lista de espera é uma caixa de seleção dentro da remoção, decisão do admin, nunca automática; vem sugerida em "sem vagas" e "a data não serviu". A fila recebe sempre a data e hora do interesse ORIGINAL, preservando a ordem de chegada', p: ['admin'] },
        { label: 'Aba Eventos — justificativa "Substituída" pede dizer POR QUEM (lista as pessoas da turma ou aceita um nome digitado); o selo mostra o nome de quem entrou e acompanha a pessoa mesmo depois de ela sair da turma', p: ['admin'] },
        { label: 'Aba Eventos — quem saiu da turma tem coluna DESTINO com selo próprio (Lista de espera · nome da turma para onde foi · Saiu), nas duas tabelas de quem saiu; antes o destino ia espremido dentro do texto do motivo e não dava para varrer a coluna', p: ['admin'] },
        ...
        { label: 'Aba Eventos — filtros por destino: Todos os interessados · Confirmados · Aguardando decisão · Não confirmados · Foram para a espera · Foram para outra turma · Removidos. Cada pessoa cai em exatamente um grupo e a soma fecha com o total, então "Todos" responde quantas pessoas se interessaram pela turma, incluindo quem saiu', p: ['admin'] },
        { label: 'Aba Eventos — "Aguardando decisão" é quem ainda não foi confirmada E ainda não tem destino: é o grupo que exige ação. Quem já tem motivo registrado aparece em "Não confirmados"', p: ['admin'] },
        ...
        { label: 'Aba Cadastrados — Lista de Espera: coluna Data mostra data E hora no formato brasileiro (10/08/2026 12:26); a hora sempre esteve gravada, só não era exibida — e a coluna Origem também mostra a hora da migração', p: ['admin'] },
        { label: 'Aba Cadastrados — Lista de Espera: coluna "Origem" mostra de qual turma a pessoa foi migrada, em que dia e hora; quem entrou direto pelo card do site aparece como "Entrou pela lista"', p: ['admin'] },
