  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Eventos — turma de público restrito: a caixa "Público restrito" fecha a turma, e o menu "⋯" → "👥 Público restrito" monta a lista de quem pode participar (busca no cadastro, uma pessoa por vez, remover por linha). Fora da lista ninguém vê a turma no site nem pode ser adicionado por você — as três portas (Confirmar, "＋ Participante", "Mover para turma") recusam e dizem que é preciso incluir na lista primeiro. Turma aberta e turma restrita convivem no mesmo evento', p: ['admin'] },
        { label: 'Aba Eventos — selo "👥 PÚBLICO RESTRITO · N" no cabeçalho da turma fechada, e aviso com nomes quando alguém está na turma (ou no evento dela, se também for restrito) sem estar na lista correspondente (marcar a caixa numa turma que já tem gente não remove ninguém) — o aviso vem com um botão "Incluir as N na lista" que regulariza todo mundo dele de uma vez, sem precisar buscar pessoa por pessoa no "👥 Público restrito"', p: ['admin'] },
