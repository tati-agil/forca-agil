  ...
  const PAGES = [
    { label: 'ADMIN', color: '#ff5252',
      features: [
        ...
        { label: 'Aba Turmas — adicionar participante manualmente, escolhendo o status (Interessada ou Inscrita) na hora, turma aberta ou com interesse encerrado', p: ['admin'] },
