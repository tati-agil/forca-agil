  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Pedidos — botão "Marcar como respondido" (manual, reversível): grava respondido:true e respondidoEm no Firebase; item ganha badge "✓ Respondido" e fica com opacidade reduzida na lista', p: ['admin'] },
      ]
    },
    ...
    const ARCH = [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'forca-agil/pedidos.js',       desc: 'Formulário público "Faça um pedido" (seção Ajuda) e painel admin Aba Pedidos. Público: seleção de tipo (tema/curso/material/dúvida/outros) + textarea + envio autenticado para Firebase pedidos/. Admin: lê node pedidos/, renderiza com chips de filtro por tipo e contagem, ordem mais recente primeiro. Cada item tem link mailto: (Responder por e-mail — abre o cliente de e-mail do admin, não envia pelo site) e botão manual "Marcar como respondido" (grava respondido/respondidoEm em pedidos/<key>).' },
