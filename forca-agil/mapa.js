  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Eventos — motivos de saída: A pedido da própria pessoa · Vai fazer em outra turma (escolhe QUAL) · Turma sem vagas · Substituída por outra pessoa (escolhe QUEM) · A data não serviu · Já participou de uma turma (escolhe QUAL ela já fez; turma já feita NÃO vira destino) · Não respondeu · Registro duplicado · Evento encerrado · Outro', p: ['admin'] },
