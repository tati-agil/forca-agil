  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Pedidos — ver todos os pedidos enviados pelo site, com filtro por tipo (tema / curso / material / dúvida / iniciativas do Time Força Ágil / outros) e contagem por tipo', p: ['admin'] },
