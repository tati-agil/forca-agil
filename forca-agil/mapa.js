  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Cadastrados — seção recolhida "Saíram da fila" abaixo da lista: quem já esteve na fila e não está mais, com origem, quando saiu, destino e motivo. Sair da fila nunca apaga o registro, mas até então não havia como enxergá-lo', p: ['admin'] },
