  ...
  function render() {
    ...
    const ARCH = [
      ...
      },
      {
        ...
        items: [
          { name: 'index.html',                  desc: 'Entrada única da aplicação. Contém todo o HTML, carrega os scripts e gerencia as seções por hash (#inicio, #turmas…). São 14 seções, entre elas #minha-area (área do participante) e #facilitador (placeholder, visível só a admin/facilitador), e o painel Admin com suas 14 abas — a última é Sorteios' },
