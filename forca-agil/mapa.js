    ...
    const ARCH = [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'forca-agil/pedidos.js',       desc: 'Formulário público "Faça um pedido" (seção Ajuda) e painel admin Aba Pedidos. Público: seleção de tipo (tema/curso/material/dúvida/outros) + textarea + envio autenticado para Firebase pedidos/. Admin: lê node pedidos/, renderiza com chips de filtro por tipo e contagem, ordem mais recente primeiro.' },
