...
(function () {
  ...
  const HIERARCHY = [
    ...
    { key: 'admin',   label: 'Admin (marcação à parte, não é degrau)',          color: '#6b7a99',
      adds: ['NÃO é o degrau seguinte de Inscrito — é uma marcação paralela: quem é admin recebe o nível "enrolled" automaticamente, mesmo sem estar inscrito em turma nenhuma. Por isso enxerga Conteúdos, Treinamento e Avaliação sem precisar de confirmação de admin.', 'Acessar o Painel Admin (11 abas: Dashboard, Eventos, Certificados, Repositório, Cadastrados, Administradores, Manual, Mapa, Testes, Pedidos, Sorteios)', 'Criar, editar e excluir turmas; cadastrar link do CMFlex por turma', 'Confirmar/desconfirmar inscrição e adicionar/remover participantes manualmente', 'Abrir/fechar check-in, gerar QR Code e emitir certificados de participação', 'Exportar CSV (estado atual, histórico e por turma)', 'Gerar lista de presença por turma pronta para impressão/PDF', 'Moderar Repositório (ocultar, restaurar, deletar conteúdos)', 'Ver e gerenciar cadastrados (filtrar, redefinir senha, resetar progresso, criar conta diretamente com senha 12345678, confirmar cadastro manualmente para quem não recebeu o link de verificação de e-mail)', 'Gerenciar lista de espera: ver quem entrou, mover pessoa diretamente para uma turma como Inscrita ou remover da lista; migrar participante de uma turma para a lista de espera (caixa dentro do modal de "Remover" — data original de interesse é preservada)', 'Gerenciar lista de administradores (restrito a tatianefdirene e danielfrazao)', 'Consultar Manual, Mapa e Testes (documentação viva do sistema)'] },
  ];
