  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        ...
        { label: 'Aba Eventos — motivos de saída: A pedido da própria pessoa · Vai fazer em outra turma (escolhe QUAL) · Turma sem vagas · Substituída por outra pessoa (escolhe QUEM) · A data não serviu · Já participou · Não respondeu · Registro duplicado · Evento encerrado · Outro', p: ['admin'] },
        { label: 'Aba Eventos — a ida para a lista de espera é uma caixa de seleção dentro da remoção, decisão do admin, nunca automática; vem sugerida em "sem vagas", "a data não serviu" e "substituída". A fila recebe sempre a data e hora do interesse ORIGINAL, preservando a ordem de chegada', p: ['admin'] },
