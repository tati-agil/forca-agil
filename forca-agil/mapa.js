...
(function () {
  ...
  const PAGES = [
    { label: 'ADMIN', color: '#6b7a99',
      features: [
        { label: '12 abas no total (Dashboard, Eventos, Certificados, Treinamentos, Repositório, Cadastrados, Administradores, Manual, Mapa, Testes, Pedidos, Sorteios); no mobile quebram em 2 linhas', p: ['admin'] },
  ...
  function render() {
    ...
    const ARCH = [
      ...
      },
      {
        ...
        items: [
          { name: 'index.html',                  desc: 'Entrada única da aplicação. Contém todo o HTML, carrega os scripts e gerencia as seções por hash (#inicio, #turmas…). São 13 seções, entre elas #minha-area (área do participante) e o painel Admin com suas 12 abas — a última é Sorteios' },
