  ...
  const PAGES = [
    { label: 'ADMIN', color: '#ff5252',
      features: [
        ...
        { label: 'Aba Turmas — criar evento (nome + carga horária em horas; pai das turmas)', p: ['admin'] },
        { label: 'Aba Turmas — editar evento (renomear, alterar carga horária)', p: ['admin'] },
        ...
        { label: 'Aba Turmas — gerar certificados de participação (aba Certificados — data e evento do Firebase; prévia disponível antes de encerrar, downloads habilitados só após encerrar)', p: ['admin'] },
