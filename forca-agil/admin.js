...
(function () {
  ...
  function openEventoFormModal(existing) {
    ...
    box.innerHTML =
      ...
      '</div>' +
      '<p style="font-size:.78rem;color:var(--ink-2);margin:8px 0 0">Os dois últimos chips do bloco "Como funciona" (abaixo do itinerário, na página Turmas). O chip curto é uma lista fechada, pra não ter "Híbrido"/"hibrido" escrito diferente em cada evento — "— usar padrão —" mantém o texto de sempre. A descrição continua livre, e é importante revisar num evento restrito a diretores: o padrão diz "aberta a todos os empregados da Previ".</p>' +
      ...
      '</div>' +
      '<div style="display:flex;gap:10px;flex-wrap:wrap">' +
        '<label class="auth-label" style="flex:1;min-width:140px">Público-alvo (chip curto)<select id="eventoFormPublicoLabel" style="padding:8px 10px;background:var(--panel-2);border:1px solid var(--line-strong);border-radius:6px;color:var(--ink);font-family:var(--font-body);width:100%">' +
          ...
          '<option value="Todos os empregados">Todos os empregados</option>' +
        '</select></label>' +
