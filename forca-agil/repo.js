...
(function () {
  ...
  const SEEDS = [
    ...
    { type: 'book',  title: 'O Poder da Simplicidade no Mundo Ágil — Susanne Andrade', url: 'https://susanneandrade.com.br/livros-2', desc: '"Agilidade é diferente de correria." Uma leitura leve e acessível que mostra o ágil como cuidado com pessoas e colaboração com propósito — ótima porta de entrada para quem está começando a jornada. Indicado por Maira Prado Louvison.' },
