...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Antes de finalizar, o sistema verifica se algum dos futuros inscritos também está interessado em outra turma (alguém pode manifestar interesse em até 3 ao mesmo tempo). Se houver, o próprio modal de confirmação lista essas pessoas e avisa que, ao continuar, o interesse delas nas outras turmas será removido automaticamente — ninguém pode ficar inscrita em mais de uma turma. Essas remoções aparecem na seção "Removidos" da outra turma, com o motivo registrado.' },
    { section: 'admin', personas: ['admin'],
