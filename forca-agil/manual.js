...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      title: 'Roteiro — Tipo de atividade (lista fechada)',
      body: 'O campo "Tipo de atividade" é uma lista fechada, em ordem alfabética: Abertura, Ambientação, Aplicação à Liderança, Autodiagnóstico, Briefing, Compromisso, Compromisso Individual, Conceituação, Dinâmica, Discussão, Experimentação com IA, Fechamento, Integração, Intervalo, Provocação, Quiz, Reflexão, Sinal/Evidência, Transição. "Intervalo" é o único com efeito prático — conta em Pausas no resumo do dia e ganha destaque laranja na lista; os demais são só um rótulo mostrado ao lado do título da atividade. Uma atividade antiga com um tipo que não existe mais nessa lista continua guardando o texto original no banco — o campo só aparece sem seleção (nem em branco nem marcando outro por engano) até alguém escolher um tipo novo e salvar.' },
    { section: 'admin', personas: ['admin'],
