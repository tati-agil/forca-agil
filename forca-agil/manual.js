...
(function () {
  ...
  const RULES = [
    ...
    { section: 'turmas', personas: ['logado', 'admin'],
      ...
      body: 'Disponível para usuário logado sem turma confirmada. Ao clicar em "♡ Tenho interesse" (estilo primário, dourado sólido), o botão vira "♡ Remover interesse" (estilo secundário, fundo escuro) e exibe a mensagem "Sua intenção foi registrada! Usaremos para dimensionar as turmas." embaixo do botão. É possível manifestar interesse em quantas turmas existirem ao mesmo tempo — não há limite fixo, o número de turmas depende do que o admin cadastrou.' },
    { section: 'turmas', personas: ['logado', 'admin'],
