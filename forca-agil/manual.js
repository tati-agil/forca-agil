...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Ao criar/editar uma atividade, o bloco "Sub-etapas (opcional)" transforma ela numa seção: cada sub-etapa tem só título e duração (sem horário próprio), e a duração da seção passa a ser a SOMA das sub-etapas, calculada e travada automaticamente (o campo Duração fica só leitura enquanto houver sub-etapas). Na lista, a seção aparece numerada (1, 2, 3...) com um botão "▲ Recolher"/"▼ Ver etapas"; as sub-etapas aparecem recuadas por baixo, numeradas 4.1, 4.2... Excluir todas as sub-etapas de uma atividade faz a duração voltar a ser editável manualmente.' },
    { section: 'admin', personas: ['admin'],
