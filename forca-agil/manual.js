...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Cards por turma com badge ABERTA/FINALIZADA, contagem de inscritos/interessados e badge pulsante "CHECK-IN ABERTO · DD/MM" quando o check-in do dia está ativo. Botões globais "↓ Estado atual" e "↓ Histórico" exportam CSV (encoding Windows-1252 — acentos e travessão corretos no Excel pt-BR, sem BOM). Cada card tem botões de ação e tabela de participantes. Cada turma tem botão "↓ CSV" para exportação individual.' },
    { section: 'admin', personas: ['admin'],
