...
(function () {
  ...
  const RULES = [
    ...
    { section: 'quiz', personas: ['admin'],
      ...
      body: 'Admin pode resetar o progresso de qualquer colaborador. Apaga: quiz, patente, pontos. Remove do ranking. Ação irreversível. Após o reset, a pessoa pode refazer o quiz e revelar a patente novamente — essa é a única forma de refazer.' },
