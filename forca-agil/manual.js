...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Cada linha com status "Interessado" tem um seletor "Justificar…" na coluna de ações. O admin escolhe entre "Sem vagas" (a pessoa queria mas a turma lotou) ou "Substituída" (outra pessoa foi no lugar). Ao selecionar, um badge colorido aparece ao lado do badge "Interessado": laranja para "Sem vagas", lilás para "Substituída". Para desfazer, basta selecionar "Justificar…" de volta — limpa o motivo. Disponível com a turma aberta ou encerrada.' },
    { section: 'admin', personas: ['admin'],
