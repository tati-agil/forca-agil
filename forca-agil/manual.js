...
(function () {
  ...
  const RULES = [
    ...
    { section: 'turmas', personas: ['visitante', 'logado', 'colaborador', 'admin'],
      ...
      body: 'Exibido antes da agenda D1–D5 para todos. Mostra 4 métricas (5 dias, ~2h por encontro, dinâmicas práticas, participação opcional) e uma descrição geral.' },
    ...
    { section: 'conteudos', personas: ['visitante'],
      title: 'Acesso',
      body: 'Visitante vê todas as 6 seções numeradas (01 Mapa da Galáxia, 02 A Força, 03 Yoda, 04 Arquétipos, 05 Lado Sombrio, 06 Trilogia) — somente leitura, sem pontos.' },
