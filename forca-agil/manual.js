...
(function () {
  ...
  const RULES = [
    ...
    { section: 'turmas', personas: ['visitante', 'logado', 'admin'],
      title: 'Cada botão de interesse só recebe um clique-listener',
      body: 'Revisitar a página Turmas (ou fazer login/logout nela) não duplica o comportamento do botão — cada botão só reage a um clique por vez, mesmo depois de várias idas e vindas.' },
    { section: 'turmas', personas: ['logado', 'admin'],
