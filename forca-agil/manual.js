...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: '13 abas no painel: Dashboard, Eventos, Certificados, Treinamentos, Repositório, Cadastrados, Administradores, Diretores, Manual, Mapa, Testes, Pedidos e Sorteios. No desktop ficam em linha única. No mobile podem quebrar em 2 linhas com fonte reduzida para todas ficarem visíveis sem scroll horizontal.' },
    { section: 'admin', personas: ['admin'],
