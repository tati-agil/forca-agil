...
(function () {
  ...
  const RULES = [
    ...
    { section: 'minha-area', personas: ['logado', 'inscrito', 'admin'],
      ...
      body: 'O link "Minha Área" aparece no menu para qualquer pessoa logada, mesmo sem estar confirmada em turma nenhuma. Quem ainda não foi confirmado vê uma mensagem explicando que a turma, a frequência e o certificado aparecem ali assim que o admin confirmar a inscrição — e continua podendo acompanhar os próprios pedidos.' },
    { section: 'minha-area', personas: ['inscrito', 'admin'],
      title: 'Minhas turmas e frequência',
      body: 'Para cada turma em que a pessoa está confirmada, aparece um cartão com: o nome da turma e um selo dizendo se está "Em andamento" ou "Concluída"; o nome do evento e a carga horária; as datas dos encontros; e a frequência dela — uma barra de percentual, a contagem "X de Y encontros" e a lista dos dias, com ✓ nos que tiveram presença registrada. Junto vem o percentual mínimo exigido por aquele evento para ter direito ao certificado, para a pessoa saber sozinha se está dentro ou não.' },
    { section: 'minha-area', personas: ['inscrito', 'admin'],
