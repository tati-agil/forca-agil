...
(function () {
  ...
  const RULES = [
    ...
    { section: 'inicio', personas: ['visitante', 'logado', 'inscrito', 'admin'],
      ...
      body: 'Bloco decorativo (sem efeito ao passar o mouse) logo abaixo do topo da página. Navega direto para a página Conteúdos.' },
    { section: 'inicio', personas: ['visitante', 'logado', 'inscrito', 'admin'],
      title: 'Card "Como funciona" → Repositório',
      body: 'Bloco decorativo (sem efeito ao passar o mouse) logo abaixo do topo da página. Navega direto para a página Repositório.' },
    { section: 'inicio', personas: ['visitante', 'logado', 'inscrito', 'admin'],
      title: 'Card "Como funciona" → Treinamento Jedi',
      body: 'Bloco decorativo (sem efeito ao passar o mouse) logo abaixo do topo da página. Navega direto para a página Treinamento Jedi.' },
    { section: 'inicio', personas: ['visitante', 'logado', 'inscrito', 'admin'],
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Aparece no card de uma turma finalizada só quando há pelo menos uma pessoa removida. Mostra nome, e-mail, área, data de remoção e o histórico de presença (mesmas colunas por dia da tabela principal, com os mesmos selos "✓ qr" / "✓ adm") — mas só leitura, sem botões de ação.' },
    { section: 'admin', personas: ['admin'],
