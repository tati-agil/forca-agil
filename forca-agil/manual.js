...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Turma finalizada exibe tabela com colunas por dia (ex: 11/08, 12/08…) e uma coluna Status (Inscrito). Cada célula de dia mostra um selo de presença ou o botão "—" clicável. Clicar em "—" registra presença retroativa a qualquer hora, sem restrição de data. Última coluna mostra frequência X/5 em verde (atingiu o critério) ou vermelho (não atingiu). Critério padrão: 75% de presença (4 de 5 dias).' },
    { section: 'admin', personas: ['admin'],
      title: 'Aba: Turmas — quem registrou a presença (QR vs admin)',
      body: 'O selo de presença de cada dia diferencia quem fez o registro: "✓ qr" (verde) — a própria pessoa escaneou o QR Code no dia do evento; "✓ adm" (ciano) — o admin registrou manualmente pelo botão "—". As duas formas contam igual para a frequência.' },
    { section: 'admin', personas: ['admin'],
