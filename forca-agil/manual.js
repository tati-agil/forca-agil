...
(function () {
  ...
  const RULES = [
    ...
    { section: 'turmas', personas: ['logado', 'admin'],
      title: 'Registrar interesse → botão vira "Remover interesse" + status "Intenção acolhida"',
      body: 'Disponível para qualquer usuário logado, em qualquer turma com interesse aberto — inclusive quem já está inscrita (confirmada) em outra turma. Ao clicar em "♡ Tenho interesse" (estilo primário, dourado sólido), o botão vira "♡ Remover interesse" (estilo secundário, fundo escuro) e exibe a mensagem "Intenção acolhida · Seu interesse nesta turma já foi registrado. A inscrição no CMFlex será feita na próxima etapa." embaixo do botão. É possível manifestar interesse em quantas turmas existirem ao mesmo tempo — não há limite fixo, o número de turmas depende do que o admin cadastrou; só a confirmação como inscrita é exclusiva de uma turma (ver regra "confirmar inscrição" no Admin).' },
    { section: 'turmas', personas: ['logado', 'admin'],
