...
(function () {
  ...
  const RULES = [
    ...
    { section: 'inicio', personas: ['visitante', 'logado', 'colaborador', 'admin'],
      title: 'Crawl de abertura — pausar / retomar',
      body: 'Clicar em qualquer área do crawl pausa ou retoma a animação. O botão "⏸ Pausar" / "▶ Continuar" abaixo do crawl faz o mesmo. Permite ao usuário ler o texto no próprio ritmo.' },
    { section: 'inicio', personas: ['visitante', 'logado', 'colaborador', 'admin'],
      title: 'Crawl de abertura — ler texto completo',
      body: 'O botão "≡ Ler texto" para a animação e exibe o texto do crawl de forma estática e legível (sem perspectiva). O botão "✕ Fechar texto" retorna ao crawl animado do início.' },
    { section: 'inicio', personas: ['visitante', 'logado', 'colaborador', 'admin'],
    ...
    { section: 'turmas', personas: ['logado', 'colaborador', 'admin'],
      title: 'Botão "Tenho interesse" / "Remover interesse"',
      body: 'Ao clicar, registra o interesse no Firebase (turmas-interesse/<turma>/<emailKey>) e o botão muda para "Remover interesse". Ao clicar novamente, marca removed:true no registro e o botão volta para "Tenho interesse". Cada ação gera uma entrada de log em turmas-interesse-log com action:"registrado" ou "removido".' },
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Exibe duas tabelas por turma: Ativos (removed:false) e Removidos (removed:true). Badge mostra apenas os ativos. Botão "Exportar Excel" gera arquivo .xls (TSV com BOM) com todas as turmas, coluna Status (Ativo/Removido), datas de registro e remoção.' },
    { section: 'admin', personas: ['admin'],
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Disponível para qualquer pessoa cadastrada, não só colaboradores. Apaga autodiagnóstico, missões, Kyber Game, patente, XP e remove do ranking. Ação irreversível — pede confirmação antes de executar. Após o reset a tabela recarrega automaticamente e a coluna XP exibe "—" para a pessoa resetada.' },
    { section: 'admin', personas: ['admin'],
