...
(function () {
  ...
  const RULES = [
    ...
    { section: 'inicio', personas: ['visitante', 'logado', 'colaborador', 'admin'],
      ...
      body: 'Três cards clicáveis logo abaixo do hero, cada um navega direto para a página correspondente (Conteúdos, Repositório, Quiz Jedi). Visível e funcional para todos.' },
    { section: 'inicio', personas: ['visitante', 'logado', 'colaborador', 'admin'],
