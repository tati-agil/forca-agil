...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Disponível para qualquer pessoa cadastrada, não só colaboradores. Apaga fa-progress/<emailKey> e remove do ranking (players — busca por email, pois a chave de players é name__turma, não emailKey). Ação irreversível — pede confirmação antes de executar. Após o reset a tabela recarrega automaticamente e a coluna XP exibe "—". Na próxima vez que a pessoa fizer login (ou recarregar a página), o localStorage dela é limpo (fa-game-v2, fa-missions-xp, fa-kyber-done, fa-patente-revealed, fa-patente-publicada etc.) e todos os jogos ficam habilitados novamente para refazer.' },
    { section: 'admin', personas: ['admin'],
