...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      title: 'Aba: Facilitadores',
      body: 'Mesmo formato da aba Diretores (lista + formulário de adicionar/remover, qualquer admin gerencia), mas para outro fim: quem estiver aqui — junto com qualquer admin — enxerga o link "Facilitador" no menu (entre Minha Área e Ajuda) e acessa a página #facilitador. Estar aqui não dá acesso ao painel admin nem muda nível de acesso. Quem não está nesta lista e não é admin não vê o link, e acessar #facilitador direto pela URL redireciona para o início. A página em si está com conteúdo placeholder — "em construção" — até o conteúdo real ser definido.' },
    { section: 'admin', personas: ['admin'],
      title: 'Aba: Manual',
