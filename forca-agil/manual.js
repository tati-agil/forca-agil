...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      title: 'Aba: Turmas — consultar interessados/inscritos',
      body: 'Cada card de turma mostra a lista de participantes ativos com nome, e-mail, área, data de registro e uma coluna Status ("Interessado" enquanto a turma está aberta, "Inscrito" após finalizada).' },
    { section: 'admin', personas: ['admin'],
