...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'O painel Admin não exibe nenhuma informação relacionada a XP, pontuação ou experiência — nem em colunas de tabela, selos, títulos, textos ou botões. A coluna XP foi removida da aba Cadastrados.' },
    { section: 'admin', personas: ['admin'],
      title: 'Aba: Testes',
