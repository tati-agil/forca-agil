...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Clicar "✓ Marcar como respondido" abre um seletor "— quem respondeu? —" com a lista de administradores (fa-admins + os 2 super-admins fixos, nomes buscados em fa-users). Escolher um nome e clicar "Confirmar" grava respondido:true, respondidoEm (agora) e respondidoPor {name, email} em pedidos/<key>. "✕ Desmarcar" reverte tudo isso de uma vez (volta respondido:false e limpa respondidoEm/respondidoPor). Cada pedido mostra o prazo em dias úteis: pendente exibe "Em aberto há N dias úteis" (fica laranja a partir de 2 dias); respondido exibe "Respondido por NOME em DATA — N dias úteis depois do pedido" em verde. Regra de cálculo: dias úteis são segunda a sexta; se o pedido chegou ou foi marcado como respondido num sábado ou domingo, a data conta como se fosse 8h da segunda-feira seguinte, tanto para o início quanto para o fim da contagem.' },
    { section: 'menu', personas: ['visitante', 'logado', 'inscrito', 'admin'],
