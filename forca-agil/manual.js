...
(function () {
  ...
  const RULES = [
    ...
    { section: 'admin', personas: ['admin'],
      ...
      body: 'Aparece em qualquer card de turma (interesse aberto ou encerrado) só quando há pelo menos uma pessoa removida. Mostra nome, e-mail, área, DATA INTERESSE, DATA REMOÇÃO, destino e o motivo (manual pelo admin, ou automático por ter sido confirmada em outra turma) — tudo só leitura, sem botões de ação. As colunas por dia e a de frequência só entram quando alguém do grupo de fato tem presença registrada: quem saiu sem nunca ter sido confirmada não tem check-in nenhum, e a tabela virava colunas de traço empurrando motivo e destino para fora da tela. Havendo presença, ela aparece com os mesmos selos "✓ qr" / "✓ adm" da lista de participantes — o histórico de quem participou e depois saiu não se perde.' },
    { section: 'admin', personas: ['admin'],
