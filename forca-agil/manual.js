...
(function () {
  ...
  const RULES = [
    ...
    { section: 'entrar', personas: ['visitante', 'logado', 'inscrito', 'admin'],
      title: 'Segurança — três camadas de proteção',
      body: '1. Site oculto: o body inteiro fica invisível até o Firebase confirmar autenticação — visitante vê só o modal de login, sem nada por baixo.\n2. Regras do banco (servidor): todos os nós do Firebase exigem autenticação com @previ.com.br para leitura e escrita — não existe nenhum nó público. Mesmo acesso direto ao banco sem autenticação é recusado pelo servidor.\n3. Nível enrolled: acesso a Conteúdos e Treinamento Jedi exige confirmação explícita pelo admin (campo confirmedByAdmin no banco) — manifestar interesse não basta.' },
    { section: 'entrar', personas: ['visitante'],
