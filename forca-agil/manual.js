...
(function () {
  ...
  const RULES = [
    ...
    { section: 'turmas', personas: ['logado', 'inscrito', 'admin'],
      ...
      body: 'Cada evento que já tem turma na vitrine E tem esse conteúdo preenchido pelo admin ("Editar evento" na aba Eventos do painel) ganha, logo abaixo da grade de cards dele, um bloco "A Missão" (título curto + texto) e, se o evento tiver itinerário cadastrado ou tópicos preenchidos, "Como funciona": 4 métricas — dias de encontro e horas por encontro calculados automaticamente a partir do itinerário e da carga horária do evento, mais "Prática" e "Opcional" (fixos, iguais para todo evento) — e uma descrição dos tópicos abordados. Evento sem nenhum desse conteúdo preenchido não ganha bloco nenhum, nem vazio.' },
    { section: 'turmas', personas: ['logado', 'inscrito', 'admin'],
