...
title: 'Cadastrados — corrigir e-mail só em cadastro criado pelo painel',
    ...
    { section: 'Admin',
      title: 'Turmas — público restrito: as três portas do painel recusam quem está fora da lista',
    ...
    { section: 'Admin',
      title: 'Turmas — os três caminhos para "Inscrita" gravam o mesmo registro',
      motivo: 'Requer 3 pessoas de teste. Fazer cada uma virar Inscrita por um caminho diferente: (a) ela clica "Tenho interesse" e o admin clica "Confirmar"; (b) o admin usa "＋ Participante" e escolhe "Inscrita"; (c) ela está na lista de espera do evento e o admin usa "Mover para turma". Verificar que nos TRÊS casos o registro em turmas-interesse fica com status "inscrito" E confirmedByAdmin preenchido, que nenhuma das três mostra o selo "Confirmação incompleta" no painel, e que as três acessam Conteúdos/Treinamento e veem a Minha Área como confirmada. O caminho por onde a pessoa entrou não pode fazer diferença nenhuma para ela.' },
    { section: 'Admin',
