...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      title: 'Roteiro-base — botão "↩ Desfazer última migração" (só na DIRETORES)',
      motivo: 'Não automatizado porque grava dados reais em produção. Os botões que disparavam novas migrações ("📥 Importar resultados esperados", "🔎 Migração Antes x Depois" e "🧹 Limpeza final de consistência") foram removidos da tela — eram ações pontuais já aplicadas, não fazem mais sentido como botão permanente. Só "↩ Desfazer última migração" continua existindo, ao lado de "🗑 Excluir dia", e só no roteiro-base que já tem a atividade "EPISÓDIO FINAL — O COMPROMISSO DA LIDERANÇA" (hoje, só "FORÇA ÁGIL - DIRETORES"). Clicar o botão: (1) se nunca houve nenhuma migração aplicada nesse roteiro, avisa "Não há nenhuma migração aplicada pra desfazer neste roteiro", sem erro; (2) se já houve, pede confirmação mostrando a data/hora da última aplicação e quantos campos seriam restaurados; confirmar e conferir que cada campo tocado pela última migração volta exatamente ao valor de antes dela (não um estado intermediário de uma migração mais antiga). Conferir também que o botão NÃO aparece no roteiro-base de nenhum outro evento.' },
    { section: 'Admin',
