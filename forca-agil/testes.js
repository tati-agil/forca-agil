...
title: 'Cadastrados — corrigir e-mail só em cadastro criado pelo painel',
    ...
    { section: 'Admin',
      ...
      motivo: 'Requer uma conta de teste confirmada numa turma. (1) Com a turma SEM a flag, abrir o Treinamento com essa conta: nenhum convite da dinâmica aparece. (2) No menu ⋯ da turma, "🎯 Liberar Construção da Aposta"; recarregar o Treinamento da conta de teste: o convite aparece, com o nome da turma. (3) Abrir a dinâmica e percorrer as dez etapas. Em NENHUMA delas — nem em rótulo, nem em ajuda, nem no "Ver exemplo", nem no Mapa da Aposta no fim — pode aparecer OKR, Objective ou Key Result. Se aparecer, a oficina perdeu o ponto alto e é bug. (4) A trilha lateral lista as dez etapas desde o começo, mas as que ainda não chegaram não clicam. (5) No Sintoma, escrever algo com "porque": aparece o aviso pedindo só o que é observado, e o segundo clique em Continuar segue assim mesmo — o aviso convida, não bloqueia. (6) Em Mudanças mensuráveis, preencher indicador, atual, meta e prazo: a frase consolidada se monta sozinha embaixo. (7) Só depois do clique da facilitadora em "Revelar conexões" aparecem Missão→Objective e Mudanças mensuráveis→Key Results, mais o ciclo PHEED. (8) Fechar a dinâmica e abrir de novo: tudo o que foi escrito continua lá. (9) No painel do facilitador, "Reiniciar dinâmica": começa vazia, e a execução anterior NÃO pode ter sido apagada.' },
    { section: 'Admin',
