...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      title: 'Roteiro-base — escrita negada pelas regras do banco mostra erro, nunca some em silêncio',
      motivo: 'roteiros-evento/$eventoKey só é gravável por dois e-mails fixos em database.rules.json — qualquer outro admin com acesso ao painel abre e edita o formulário normalmente, mas a gravação é recusada pelo Firebase. Não automatizado com a regra de segurança real (a suíte roda com Firebase falso, sem regras); testado com o Firebase falso configurado para negar a escrita (window.__CFG.fail). Verificar, num evento de teste com uma atividade já preenchida: (1) apagar o conteúdo de "Objetivo" e clicar Salvar; se a escrita for negada, deve aparecer um alerta "Não foi possível salvar…", NUNCA o modal fechando em silêncio como se tivesse dado certo; (2) reabrir a mesma atividade — o campo deve continuar com o texto ORIGINAL (a escrita nunca saiu do navegador), nunca vazio nem com um valor a metade; (3) o mesmo vale para criar/excluir/mover/duplicar atividade ou dia, personalizar/restaurar/remover por turma e salvar condução — toda ação de escrita deste editor passa pelo mesmo alerta em vez de recarregar como se nada tivesse acontecido.' },
    { section: 'Admin',
