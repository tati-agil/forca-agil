  ...
  const TECNICOS = [
    ...
    },
    {
      ...
      tests: [
        ...
        { id: 'adm-tabs',   label: 'Abas Admin presentes (10: Dashboard/Eventos/Certificados/Repositório/Cadastrados/Administradores/Manual/Mapa/Testes/Pedidos)', run: function () { return document.querySelectorAll('.admin-tab-btn').length === 10; } },
