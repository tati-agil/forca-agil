...
{ section: 'Admin',
    ...
    { section: 'Admin',
      ...
      motivo: 'Nem todo evento quer fila, e isso é decisão do admin. Em "✎ Editar evento", a caixa "Aceitar lista de espera neste evento". Verificar: (1) evento que existia ANTES deste controle abre com a caixa marcada e o card continua na página Turmas — nada some sozinho no deploy; (2) evento novo já nasce com a caixa marcada; (3) desmarcando e salvando, o card "Lista de Espera" some do grupo daquele evento na página Turmas, e o card do OUTRO evento (se houver, com a caixa marcada) continua lá — o controle é por evento, não global; (4) com a caixa desmarcada E gente já na fila, a seção Lista de Espera daquele evento continua aparecendo no painel, com um aviso em cima dizendo que está desligada — ninguém é escondido nem apagado, este é o ponto: desligar impede entrada nova, não desfaz o que já existe; (5) voltando a marcar, o card reaparece no site e a fila volta a aceitar gente, com quem já estava ainda lá, na mesma ordem; (6) evento com a caixa marcada mas SEM turma nenhuma continua sem card — as duas condições valem juntas.' },
    { section: 'Admin',
