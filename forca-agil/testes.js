...
(function () {
  ...
  const COMPORTAMENTO_MANUAL = [
    ...
    { section: 'Avaliação',
      ...
      motivo: 'Confirmar a mesma pessoa em 2 turmas diferentes (podem ser de oficinas diferentes) e liberar avaliacaoHabilitada em ambas. Ao abrir a aba Avaliação: (1) aviso dourado "esta é a 1ª de 2" aparece no topo do formulário; (2) preencher e enviar a primeira; (3) o formulário da SEGUNDA turma carrega automaticamente, sem passar pela tela de agradecimento; (4) após enviar a segunda, agora sim a tela de agradecimento aparece listando as duas turmas em "Avaliação enviada para".' },
    { section: 'Avaliação',
