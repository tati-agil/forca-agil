...
(function () {
  ...
  const TECNICOS = [
    ...
    },
    {
      ...
      tests: [
        ...
        { id: 'adm-tabs',   label: 'Abas Admin presentes (8: Turmas/Repositório/Cadastrados/Administradores/Manual/Mapa/Testes/Pedidos)', run: function () { return document.querySelectorAll('.admin-tab-btn').length === 8; } },
  ...
  const COMPORTAMENTO_MANUAL = [
    ...
    { section: 'Certificados v1.0',
      ...
      motivo: 'Cenário de referência aprovado. Verificar: nome "ADRIANO CORREIA DE CAMARGO" — fonte 55px, sem redução; evento "FORÇA ÁGIL · JORNADA DE IMERSÃO" — fonte 29px; turma "Turma 1 — Agosto 2026" — fonte 19px; período (38 chars) — fonte 24px; carga "20h" — fonte 48px; emissão "Emitido em 27 de agosto de 2026" — fonte 19px. Composição visualmente idêntica ao certificado aprovado.' },
    { section: 'Certificados v1.0',
    ...
    { section: 'Certificados v1.0',
      ...
      motivo: 'Verificar: (1) período reduz de 24px para aprox. 19px automaticamente; (2) cabe dentro dos 400px; (3) permanece ao lado do ícone de calendário do template; (4) não invade o badge.' },
    { section: 'Certificados v1.0',
