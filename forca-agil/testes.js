...
(function () {
  ...
  const COMPORTAMENTO_MANUAL = [
    ...
    { section: 'Turmas',
      title: 'Após registrar interesse → status "Intenção acolhida" com mensagem sobre próxima etapa no CMFlex',
      motivo: 'Verificar visualmente ao clicar em "Tenho interesse": embaixo do botão deve aparecer "Intenção acolhida · Seu interesse nesta turma já foi registrado. A inscrição no CMFlex será feita na próxima etapa." — sem usar a palavra "inscrita" nesse estado.' },
    { section: 'Turmas',
