...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      title: 'Admin — visibilidade das 12 abas no mobile',
      motivo: 'Acessar o painel Admin em tela estreita (celular). Verificar: todas as 12 abas (Dashboard, Eventos, Certificados, Repositório, Cadastrados, Administradores, Diretores, Manual, Mapa, Testes, Pedidos, Sorteios) estão visíveis (quebram em 2 linhas); nenhuma aba fica oculta ou cortada.' },
    { section: 'Deploy',
