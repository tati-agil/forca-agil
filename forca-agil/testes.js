...
(function () {
  ...
  const COMPORTAMENTO_MANUAL = [
    ...
    { section: 'Admin',
      ...
      motivo: 'Requer turma com pelo menos 1 pessoa com status Interessado. Verificar: (1) na linha de cada Interessado, aparece seletor "Justificar…" antes do botão "Confirmar"; (2) selecionar "Sem vagas" exibe badge laranja "SEM VAGAS" ao lado do badge "Interessado" e salva motivoNaoConfirmado:"sem_vagas" no Firebase; (3) selecionar "Substituída" exibe badge lilás "SUBSTITUÍDA" e salva "substituida"; (4) selecionar "Justificar…" de volta limpa o motivo e remove o badge; (5) funciona com a turma aberta ou com interesse encerrado.' },
    { section: 'Admin',
