...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      ...
      motivo: 'Não automatizado porque depende de digitação e da tecla Enter em tempo real. Numa caixa de texto do formulário de atividade (ex: Passo a passo), digitar "1. primeiro passo" e apertar Enter: a linha seguinte já deve começar sozinha com "2. " (sem precisar digitar o número); repetir mais uma vez e conferir "3. ". Depois, numa linha nova, apertar Enter sem digitar nada além do número (ex: deixar só "4. " e apertar Enter): o marcador deve sumir e a numeração parar de continuar (a linha seguinte fica em branco, sem "5. "). Repetir o mesmo teste com um marcador de lista digitado à mão (ex: "- item") — deve continuar com "- " na linha seguinte. Conferir que isso NÃO acontece dentro de uma lista de verdade criada pelos botões "• Lista"/"1. Lista" (ali quem numera é o próprio navegador, então digitar Enter simplesmente continua a lista nativa, sem qualquer texto "1." aparecendo dentro do conteúdo). Por fim, clicar no botão "↵ Espaço" no meio de um texto: deve inserir uma linha em branco visível naquele ponto, sem apagar o que já estava escrito antes ou depois do cursor.' }
  ];
