...
(function () {
  ...
  const COMPORTAMENTO_MANUAL = [
    ...
    { section: 'Turmas',
      title: 'Sem listener duplicado ao revisitar a página Turmas (regressão corrigida)',
    ...
    { section: 'Turmas',
      title: 'Botão desabilitado durante a gravação — sem duplicação por clique duplo (regressão corrigida)',
    ...
    { section: 'Admin',
      title: 'Link "Admin" oculto após logout — inclusive no mobile com menu aberto',
    ...
    { section: 'Admin',
      ...
      motivo: 'Verificar que nenhuma ação do painel usa confirm() ou alert() nativos do browser. Testar: finalizar turma, reabrir turma, remover inscrito, resetar progresso, redefinir senha, ocultar/deletar conteúdo do repositório. Todos devem abrir modal visual com botões estilizados, não o diálogo cinza padrão do browser.' },
    { section: 'Admin',
    ...
    { section: 'Admin',
      title: 'Exportar CSV "Estado Atual" — não inclui removidos',
    ...
    { section: 'Admin',
      title: 'Exportar CSV "Histórico" — inclui removidos e identificação do admin',
    ...
    { section: 'Admin',
      title: 'Exportar CSV individual por turma — não inclui removidos',
    ...
    { section: 'Admin',
      title: 'CSV "Estado Atual" — coluna "Adicionado por" com nome do admin',
