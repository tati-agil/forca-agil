...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      ...
      motivo: 'Não automatizado porque grava dados reais. Abrir "+ Adicionar atividade" (ou editar uma existente) e conferir que o campo "Tipo de atividade" oferece exatamente: Abertura, Ambientação, Briefing, Dinâmica, Sinal/Evidência, Provocação, Reflexão, Conceituação, Discussão, Transição, Experimentação com IA, Compromisso, Fechamento, Intervalo (nessa ordem, mais a opção em branco "—"). Escolher "Intervalo" numa etapa e conferir que ela ainda conta em "Pausas" no resumo do dia e ganha o badge laranja na lista, exatamente como antes — só o texto ao redor da lista mudou, o comportamento de "Intervalo" continua. Abrir uma atividade antiga cadastrada com um tipo que não existe mais nesta lista (ex: "Debrief", "Outro", "Exercício") e conferir que o campo aparece sem nenhuma opção selecionada (nem a atual nem outra por engano) — o valor antigo continua guardado no banco até a pessoa escolher um tipo novo e salvar.' },
    { section: 'Admin',
