...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      title: 'Roteiro — seção com sub-etapas: duração somada, numeração e recolher/expandir',
      motivo: 'Não automatizado porque grava dados reais. Criar uma atividade com 3 sub-etapas (ex: 1, 3 e 2 minutos). Conferir: (1) o campo Duração da seção fica travado mostrando 6 (a soma), tanto ao criar quanto reabrindo pra editar; (2) na lista, a seção aparece com "· 3 etapas" no título e um botão "▲ Recolher"; clicar recolhe as sub-etapas, clicar de novo ("▼ Ver etapas") mostra de volta; (3) as sub-etapas aparecem numeradas 4.1, 4.2, 4.3 (usando a posição da seção-mãe) e sem coluna de horário própria; (4) no roteiro da turma, abrir a atividade mostra as mesmas sub-etapas dentro do corpo expandido; (5) remover todas as sub-etapas no formulário de edição faz o campo Duração voltar a ser editável manualmente.' },
    { section: 'Admin',
