...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      title: 'Roteiro — identidade visual (logo e fontes do site) no PDF exportado',
      motivo: 'Não automatizado porque depende do diálogo de impressão do navegador. Clicar "🖨 Agenda resumida" e, em outro teste, "🖨 Roteiro completo" (roteiro-base ou roteiro da turma) e conferir em cada um: (1) logo abaixo do botão "Imprimir / salvar como PDF" aparece uma barra escura com o mesmo ícone (círculo + triângulo dourado) do menu superior do site, o texto "FORÇA ÁGIL" e "PREVI · OFICINA DE AGILIDADE ORGANIZACIONAL" — não é mais um documento em branco só com título e tabela; (2) o título principal e os títulos de cada atividade usam uma fonte com mais peso visual (Oswald), diferente da fonte padrão do navegador; (3) usar "Imprimir / salvar como PDF" com a opção "Gráficos de fundo" (ou "Imprimir cores e imagens de fundo") MARCADA no diálogo do navegador e conferir que a barra escura sai com a cor de fundo no PDF gerado, não em branco; repetir com essa opção DESMARCADA e confirmar que o texto da barra (ícone, "FORÇA ÁGIL", "Previ") continua legível mesmo sem a cor de fundo. A dica visível na tela (nunca impressa) deve mencionar tanto "Cabeçalhos e rodapés" quanto "Gráficos de fundo".' }
  ];
