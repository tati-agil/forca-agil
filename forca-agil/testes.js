...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      ...
      motivo: 'Não automatizado porque depende de digitação e da tecla Enter em tempo real. Numa caixa de texto do formulário de atividade (ex: Passo a passo), digitar "1. primeiro passo" e apertar Enter: a linha seguinte já deve começar sozinha com "2. " (sem precisar digitar o número); repetir mais uma vez e conferir "3. ". IMPORTANTE: digitar o "1." e o espaço normalmente pelo teclado (não colar) — é exatamente esse espaço que o navegador às vezes troca por um espaço não separável, e é esse caso que precisa continuar funcionando. Depois, numa linha nova, apertar Enter sem digitar nada além do número (ex: deixar só "4. " e apertar Enter): o marcador deve sumir e a numeração parar de continuar (a linha seguinte fica em branco, sem "5. "). Repetir o mesmo teste com um marcador de lista digitado à mão (ex: "- item") — deve continuar com "- " na linha seguinte. Conferir que isso NÃO acontece dentro de uma lista de verdade criada pelos botões "• Lista"/"1. Lista" (ali quem numera é o próprio navegador, então digitar Enter simplesmente continua a lista nativa, sem qualquer texto "1." aparecendo dentro do conteúdo). Clicar no botão "↵ Espaço" no meio de um texto: deve inserir uma linha em branco visível naquele ponto, sem apagar o que já estava escrito antes ou depois do cursor. Por fim, testar o Tab: dentro de uma lista de verdade (criada pelo botão), posicionar o cursor num item e apertar Tab — o item deve indentar como sub-item da lista; Shift+Tab deve desfazer o recuo; fora de uma lista, apertar Tab deve inserir um recuo no texto no lugar do cursor, e em NENHUM caso o foco deve sair da caixa e pular para o próximo campo do formulário.' }
  ];
