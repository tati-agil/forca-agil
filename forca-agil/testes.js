...
{ section: 'Minha Área',
    ...
    { section: 'Admin',
      title: 'Roteiro — Tipo de atividade: nova lista fechada de opções',
      motivo: 'Não automatizado porque grava dados reais. Abrir "+ Adicionar atividade" (ou editar uma existente) e conferir que o campo "Tipo de atividade" oferece exatamente, em ordem alfabética: Abertura, Ambientação, Aplicação à Liderança, Autodiagnóstico, Briefing, Compromisso, Compromisso Individual, Conceituação, Dinâmica, Discussão, Experimentação com IA, Fechamento, Integração, Intervalo, Provocação, Quiz, Reflexão, Sinal/Evidência, Transição (mais a opção em branco "—" no topo). Escolher "Intervalo" numa etapa e conferir que ela ainda conta em "Pausas" no resumo do dia e ganha o badge laranja na lista, exatamente como antes — só a lista e sua ordem mudaram, o comportamento de "Intervalo" continua o mesmo (não depende de posição na lista). Abrir uma atividade antiga cadastrada com um tipo que não existe mais nesta lista (ex: "Debrief", "Outro", "Exercício") e conferir que o campo aparece sem nenhuma opção selecionada (nem a atual nem outra por engano) — o valor antigo continua guardado no banco até a pessoa escolher um tipo novo e salvar.' },
    { section: 'Admin',
